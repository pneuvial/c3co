...
#'
#' @param dataAnnotTP A data frame containing the data used for the resampling.
#' Need the total copy number in tumor \code{c}, \code{b} the B allele
#' fraction in tumor, the type of alteration in \code{region} and the genotype
#' in reference \code{genotype}
#'
#' @param dataAnnotN A data frame containing the data used for the resampling.
#' Need the total copy number in normal \code{c}, \code{b} the B allele
#' fraction in normal, the type of alteration in \code{region} and the
#' genotype in reference \code{genotype}
#'
...
#'
#' @details
#' The subclones are designed to mimic intra-tumor heterogeneity.
#' In particular, all of the subclones generated by a single call to
#' \code{buildSubclones} share the same germline genotypes. Their relative
#' frequency corresponds to that of the input data.
#'
#' @examples
...
#' @export
buildSubclones <- function(len, dataAnnotTP, dataAnnotN, nbClones, bkps=list(),
                           regions=list()) {
