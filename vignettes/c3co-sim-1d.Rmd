...
Here we arbitrarily choose 5 subclones (because we know it's the true number of subclones).
...
adjustedRandIndex(cutree(hclust(dist(W), method="ward.D2"),4), cutree(hclust(dist(fitW), method="ward.D2"),4))
```
