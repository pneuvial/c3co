...
In this document we a public data set saved into the \code{c3co.data} package.
The \code{PSCBSwrapper} function segments and saves data from \code{PSCBS} format to c3co format.
