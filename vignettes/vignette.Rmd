...
df.CHR <- createZdf(minMaxPos, dataBest, chromosomes=1, var="TCN")
df.CHRC1 <- createZdf(minMaxPos, dataBest, chromosomes=1, var="Minor")
df.CHRC2 <- createZdf(minMaxPos, dataBest, chromosomes=1, var="Major")
